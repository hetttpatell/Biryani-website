...
const ContactPage = ({ onBack }) => {
  ...
  const swiggyLink = '#'; // Update with actual Swiggy link
        ...
        >
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 0 }}>
            ...
            >
              ...
              {/* Swiggy */}
              <a href={swiggyLink} target="_blank" rel="noopener noreferrer" className="hob-card">
                <svg width="34" height="34" viewBox="0 0 24 24" fill="rgba(252,128,25,0.85)">
                ...
                <div>
                  <p className="hob-card-label" style={serif}>Order Online</p>
                  <p className="hob-card-sub" style={sans}>via Swiggy →</p>
                </div>
              </a>
